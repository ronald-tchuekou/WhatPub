...
package com.whatpub.ui.pub_course;
...
public class Pub_course extends Fragment {

    public static final int ID_FRAG = R.id.nav_pub_in_course;
    ...
    private void refreshListener () {
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                notifyAdapter(context, databaseManager.getAllAnnonceInCours());
     ...
     * @param annonces Liste de tous les annocnes pour une recherche.
     */
    ...
    public static void reinitAdapter () {
        adapter = new Pub_adapter(context, databaseManager.getAllAnnonceInCours());
        recyclerView.setAdapter(adapter);
        showEmptyView();
    }
    ...
    private void initAdapter() {
        adapter = new Pub_adapter(getContext(), databaseManager.getAllAnnonceInCours());
        recyclerView.setAdapter(adapter);
    }
