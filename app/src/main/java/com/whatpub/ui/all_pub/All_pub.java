...
package com.whatpub.ui.all_pub;
...
public class All_pub extends Fragment {

    public static final int ID_FRAG = R.id.nav_all_pub;
    ...
    private void refreshListener () {
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                notifyAdapter(context, databaseManager.getAllAnnonce());
    ...
    /**
     * Fonction qui permet de faire la mis à jour de l'adaptateur.
    ...
    public static void reinitAdapter () {
        adapter = new Pub_adapter(context, databaseManager.getAllAnnonce());
        recyclerView.setAdapter(adapter);
        showEmptyView();
    }
    ...
    private void initAdapter() {
        adapter = new Pub_adapter(getContext(), annonces);
        recyclerView.setAdapter(adapter);
    }
